...
export const mockActivities: DetailedActivity[] = [
  ...
  },
  {
    ...
    description: 'Explore the ancient wonders of Rome with a local guide. This walking tour covers the Colosseum, Roman Forum, Pantheon, and Trevi Fountain. I will share historical facts and loca...',
  ...
  },
  {
    ...
    description: "Be part of our taste test panel for a new line of organic snacks. You'll sample various flavors and provide feedback on taste, packaging, and overall experience. Your input will...",
  ...
  },
  {
    ...
    category: 'Education',
    description: 'Learn the basics of Spanish conversation with a fluent speaker. This session is perfect for beginners or those looking to refresh their knowledge. We will focus on practical phr...',
  ...
  },
  {
    ...
    category: 'Gardening',
    description: 'Help with maintaining a small urban garden. Tasks include planting seasonal flowers, pruning shrubs, and general garden cleanup. All tools and gardening supplies will be provide...',
  ...
  },
  {
    ...
    category: 'Care',
    description: 'Provide companionship and assistance to an elderly person. This could include reading, playing board games, helping with light housework, or simply having a friendly conversatio...',
  ...
  },
  {
    ...
    category: 'Arts',
    description: 'Learn how to take professional-quality photos with just your smartphone. This workshop covers composition, lighting, editing, and useful apps. Suitable for all smartphone users ...',
  ...
  },
  {
    ...
    category: 'Give',
    description: 'I have an abundance of fresh, organic vegetables from my garden to share. Available are tomatoes, zucchini, bell peppers, and herbs. All grown without pesticides in my community...',
  ...
  },
  {
    ...
    category: 'Lend',
    description: 'Borrow my DSLR camera and lens set for your photography needs. The kit includes a Canon EOS 80D, three lenses (wide, standard, and telephoto), a tripod, and a carrying case. Per...',
  ...
  },
  {
    ...
    category: 'Try a Product',
    description: "Be among the first to test our new smartphone prototype before it hits the market. You'll have the opportunity to provide feedback that could influence the final product. The te...",
