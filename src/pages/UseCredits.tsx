...
// Mock data for activities to use credits for
const mockActivities: ActivityCardProps[] = [
  ...
  {
    id: '2',
    title: 'Local Artisan Cheese Tasting',
    category: 'Food & Drink',
    location: 'Rue de Seine, 75006 Paris, France',
  ...
  },
  {
    ...
    category: 'Give',
    location: 'Hauptstraße 10, Munich, Germany',
    credits: 8,
    status: 'available',
  },
  {
    id: '4',
    title: 'Electric Car for Weekend',
    category: 'Mobility',
      ...
      <PageTransition>
        <div className="container max-w-4xl mx-auto">
          <div className="flex flex-wrap items-center justify-between gap-4 mb-6">
            <div>
              <h1 className="text-2xl font-bold text-primary">Use Credits</h1>
              <p className="text-muted-foreground">Find services and goods to spend your credits on</p>
            </div>
          ...
          <div className="flex justify-between items-center mb-4">
            <h2 className="text-xl font-semibold text-primary">
              Activities to Use Credits {filteredActivities.length > 0 && `(${filteredActivities.length})`}
            </h2>
